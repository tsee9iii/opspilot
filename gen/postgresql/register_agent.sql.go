...
INSERT INTO agents (server_id, secret, version)
VALUES (
    $1,
    $2,
    $3
...
// The agent id is generated by the database.
func (q *Queries) CreateAgent(ctx context.Context, arg CreateAgentParams) (CreateAgentRow, error) {
	row := q.db.QueryRow(ctx, createAgent, arg.ServerID, arg.Secret, arg.Version)
